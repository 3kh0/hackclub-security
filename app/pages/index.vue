    ...
    <div class="max-w-6xl mx-auto space-y-8">
      ...
      <div class="bg-dark p-8 rounded-2xl">
        ...
        <div class="p-6 bg-green/10 border border-green/30 rounded-xl">
              <p class="text-green">We are currently working on a new version of the security bounty program. This new version will have better refined severity definitions and a more comprehensive program structure. We are excited to share this with you soon! Until then, we still accept submissions for all programs.</p>
            </div>
        ...
        <div class="bg-primary/20 rounded-2xl p-6 border border-primary/30">
          <div class="grid md:grid-cols-2 gap-6 text-lg">
            ...
            <ul class="list-disc list-inside text-red space-y-2">
              ...
              <li>Exploits related to the Slack platform that are out of our control</li>
            </ul>
          </div>
        </div>
